...
/**
 * /tpax <player> — send a TPA request asking to teleport to the target.
 */
public final class TpaCommand implements CommandExecutor {
    ...
    public TpaCommand(SimpleXpTeleportPlugin plugin) {
        this.plugin = plugin;
